...
export const apiService = {
  ...
  // Search entities - THIS WAS MISSING
  ...
  bulkCreate: (entity, data) =>
    api.post(`/api/${entity}/bulk`, { operation: "insertMany", data }),

  bulkDelete: (entity, filter) =>
    api.post(`/api/${entity}/bulk`, { operation: "deleteMany", data: filter }),
};
